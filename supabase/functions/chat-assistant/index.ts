...
serve(async (req) => {
  ...
  try {
    ...
    const messages: ChatMessage[] = [
      {
        role: 'assistant',
        content: 'Você é um assistente pessoal de fitness especializado em treinos, exercícios, técnicas e motivação. Responda sempre em português de forma clara e motivadora.'
      },
